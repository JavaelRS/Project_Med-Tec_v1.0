...
<head>
    ...
    <title>Minhas Consultas - Hopsital Geral</title>
</head>
<body>
    <header>
        <div class="head">
    ...
    <section>
        ...
        <div class="container">
            <h1>Consultas Agendadas de <?php echo $patientUsername ?></h1>
            <form action="#" method="POST">
                <div class="form-group">
                    <input type="submit" value="Minhas Consultas" name="consts" class="btn btn-primary">
                </div>
            </form>
            <?php
                ...
                if(isset($_POST['consts'])) {
                    ...
                    $read = new ConsDAO();
                    $read->readConsPatients($patientUsername);
                }
            ?>
        </div>
    </section>
