...
<head>
    ...
    <link rel="stylesheet" href="../css/readFiles.css">
    <title>Documentos Armazenados - Hospital Geral</title>
</head>
<body>
    <header>
        <div class="head">
    ...
    <section>
        ...
        <div class="container">
            <h1>Documentos de Clientes Armazenados</h1>
            <form action="#" method="POST">
                <div class="form-group">
                    <input type="text" class="form-control" name="nome" id="name" placeholder="Nome" required>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" name="sobrenome" id="surname" placeholder="Sobrenome" required>
                </div>
                <div class="form-group">
                    <input type="submit" value="Listar Documentos" name="docs" class="btn btn-primary">
                </div>
            </form>
            <?php
                ...
                if(isset($_POST['docs'])) {
                    ...
                    $read->readFiles($patientName, $patientSurname);
                }
            ?>
        </div>
    </section>
