...
<head>
    ...
    <link rel="stylesheet" href="../css/readPatients.css">
    <title>Pacientes Cadastrados - Hospital Geral</title>
</head>
<body>
    <header>
        <div class="head">
    ...
    <section>
        ...
        <div class="container">
            <h1>Pacientes Cadastrados no Sistema do Hospital Geral</h1>
            <form action="#" method="POST">
                ...
                <div class="form-group">
                    <input type="submit" value="Buscar Paciente" name="patient" class="btn btn-primary">
                    <input type="submit" value="Listar Todos os Pacientes" name="patients" class="btn btn-primary">
                </div>
            </form>
            <?php
                ...
                if(isset($_POST['patients'])) {
                    ...
                    $read->readPatients($name, $surname);
                }
            ?>
        </div>
    </section>
